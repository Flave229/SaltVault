...
namespace SaltVault.WebApp.Controllers
{
    public class ApiController : Controller
    {
        ...
        public ApiController(IPeopleRepository peopleRepository, IToDoRepository toDoRepository, IUserService userService, IGoogleTokenAuthentication googleTokenAuthentication)
        {
